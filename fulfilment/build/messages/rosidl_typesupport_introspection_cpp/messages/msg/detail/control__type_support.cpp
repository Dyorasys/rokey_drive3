...
{
  new (message_memory) messages::msg::Control(_init);
}

void Control_fini_function(void * message_memory)
{
  auto typed_message = static_cast<messages::msg::Control *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Control_message_member_array[2] = {
  {
    ...
    offsetof(messages::msg::Control, control),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(messages::msg::Control, distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::messages::msg::rosidl_typesupport_introspection_cpp::Control_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, messages, msg, Control)() {
  return &::messages::msg::rosidl_typesupport_introspection_cpp::Control_message_type_support_handle;
}
