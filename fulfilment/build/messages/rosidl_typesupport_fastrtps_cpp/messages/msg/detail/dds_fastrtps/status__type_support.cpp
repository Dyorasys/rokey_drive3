...
#include "messages/msg/detail/status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const messages::msg::Status & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  messages::msg::Status & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = messages::msg::Status;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const messages::msg::Status *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<messages::msg::Status *>(
    untyped_ros_message);
...
{
  return &messages::msg::typesupport_fastrtps_cpp::_Status__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages, msg, Status)() {
  return &messages::msg::typesupport_fastrtps_cpp::_Status__handle;
}
