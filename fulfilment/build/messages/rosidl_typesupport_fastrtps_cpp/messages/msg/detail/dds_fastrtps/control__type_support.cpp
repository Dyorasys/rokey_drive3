...
#include "messages/msg/detail/control__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = messages::msg::Control;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const messages::msg::Control *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<messages::msg::Control *>(
    untyped_ros_message);
...
{
  return &messages::msg::typesupport_fastrtps_cpp::_Control__handle;
}
